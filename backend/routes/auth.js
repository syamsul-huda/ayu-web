    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:sans-serif;max-width:500px;margin:0 auto;padding:24px">
          ...
          <a href="${resetUrl}" style="display:inline-block;background:linear-gradient(135deg,#00695c,#00897b);color:#fff;padding:12px 28px;border-radius:20px;text-decoration:none;font-weight:700;margin:20px 0">
            &#128273; Reset Password
          </a>
